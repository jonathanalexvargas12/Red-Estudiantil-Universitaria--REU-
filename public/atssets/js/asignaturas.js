...
document.addEventListener('DOMContentLoaded', () => {
    ...
    tablaAsignaturas.onEditar = async (id, datos) => {
        ...
        const cerrarModal = () => {
            ...
            // Limpiar eventos
            document.querySelector('.editar-close').removeEventListener('click', cerrarModal);
            window.removeEventListener('click', clickOutside);
            document.getElementById('cancelar-editar-asignatura-modal').removeEventListener('click', cerrarModal);
        };

        // Configurar eventos de cierre
        document.querySelector('.editar-close').addEventListener('click', cerrarModal);
        document.getElementById('cancelar-editar-asignatura-modal').addEventListener('click', cerrarModal);
