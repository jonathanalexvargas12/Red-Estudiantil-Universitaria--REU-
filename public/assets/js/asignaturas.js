...
document.addEventListener('DOMContentLoaded', () => {
    ...
    tablaAsignaturas.onEditar = async (id, datos, item) => {
        ...
        document.getElementById('editar-codigo-asignatura').value = item.Codigo_Asignatura || '';
        document.getElementById('editar-nombre-asignatura').value = item.Nombre_Asignatura || '';
        document.getElementById('editar-trayecto').value = item.Trayecto || '';
        document.getElementById('editar-sem-trim').value = item['Sem/Trim'] || '';
        document.getElementById('editar-valor-uc').value = item.Valor_UC || '';

        // Establecer la carrera seleccionada
        const selectCarrera = document.getElementById('editar-carrera');
        if (selectCarrera) {
            selectCarrera.value = item.Carrera || '';
        }
