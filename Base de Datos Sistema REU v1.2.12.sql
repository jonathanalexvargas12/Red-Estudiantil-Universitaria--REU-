...
-- Volcando datos para la tabla reu_db.asignaturas: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla reu_db.pensum: ~2 rows (aproximadamente)
...
REPLACE INTO `trabajo_investigacion` (`ID`, `Nombre_Investigacion`, `Carrera`, `Cedula_Estudiante`, `Nombre_Estudiante`, `Tutor_Cedula`, `Tutor_Nombre`, `Area_Interes`, `Periodo_Academico`) VALUES
	(00006, 'Bases', 'P-INF-2025', '11111111', 'Jonathan Vargas', '12000123', 'gregorio', 'bases', '2029-2'),
	(00007, 'Bases', 'P-INF-2025', '00000000', 'Daniel Betancourt', '12000111', 'karlos', 'Bases', '2028-1');
