...
REPLACE INTO `calificaciones` (`ID`, `Cedula_Estudiante`, `Nombre_Estudiante`, `Carrera`, `Trayecto`, `Sem/Trim`, `Seccion`, `Unidad_Curricular`, `Cedula_Docente`, `Nombre_Docente`, `Estado`, `Calificacion_Numerica`, `Calificacion_Cualitativa`, `Periodo_Academico`) VALUES
	(00002, '11111111', 'Jonathan Vargas', 'P-INF-2025', 1, 2, 30232, 'ING-001', '00221221', 'Nombreprofe Apellidoprofe', 'activo', 15, 'aprobado', '2026-1');
...
REPLACE INTO `carreras` (`Codigo_Carrera`, `Nombre_Carrera`, `Tipo`, `Estado`, `Total_UC`) VALUES
	('P-ADM-2025', 'Administracion', 'Trimestral', 'Activa', 40),
...
-- Volcando datos para la tabla reu_db.docentes: ~2 rows (aproximadamente)
REPLACE INTO `docentes` (`Cedula`, `Usuario`, `Nombres`, `Apellidos`, `Estado_Docente`, `Tipo`, `Fecha_Registro`) VALUES
	('00221221', 'PROFESOR', 'Nombreprofe', 'Apellidoprofe', 'activo', 'normal', '2025-04-11 22:42:15'),
...
CREATE TABLE IF NOT EXISTS `docente_asignatura` (
  ...
  CONSTRAINT `FK_docente_asignatura_pensum` FOREIGN KEY (`Pensum`) REFERENCES `pensum` (`Codigo_Pensum`) ON UPDATE CASCADE,
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci COMMENT='En esta tabla se asigna la asignatura que un docente registrado debera impartir en un periodo academico.';

-- Volcando datos para la tabla reu_db.docente_asignatura: ~1 rows (aproximadamente)
REPLACE INTO `docente_asignatura` (`ID`, `Docente_Cedula`, `Docente_Nombre`, `Asignatura`, `Num_Alumnos`, `Carrera`, `Pensum`, `Trayecto`, `Sem/Trim`, `Seccion`, `Clases_Semana`, `Estado`, `Periodo_Academico`) VALUES
	(00004, '00221221', 'Nombreprofe Apellidoprofe', 'ING-001', 25, 'P-ADM-2025', 'P-ADM-2025', 1, 2, 30231, 12, 'correcta', '2026-1');
...
-- Volcando datos para la tabla reu_db.estudiantes: ~3 rows (aproximadamente)
REPLACE INTO `estudiantes` (`Cedula`, `Usuario`, `Nombres`, `Apellidos`, `Carrera`, `Estado_Pensum`, `Estado`, `Fecha_Registro`) VALUES
	...
	('00123741', 'ESTUDIANTTE', 'Nombreest', 'Apellidoest', NULL, 'pendiente', 'regular', '2025-04-11 22:46:23'),
...
CREATE TABLE IF NOT EXISTS `estudiantes_asignatura` (
  ...
  CONSTRAINT `FK_estudiantes_asignatura_asignaturas` FOREIGN KEY (`Asignatura`) REFERENCES `asignaturas` (`Codigo_Asignatura`) ON UPDATE CASCADE,
  CONSTRAINT `FK_estudiantes_asignatura_estudiantes` FOREIGN KEY (`Estudiante_Cedula`) REFERENCES `estudiantes` (`Cedula`) ON UPDATE CASCADE,
  CONSTRAINT `FK_estudiantes_asignatura_periodo_academico` FOREIGN KEY (`Periodo_Academico`) REFERENCES `periodo_academico` (`Periodo_Academico`) ON UPDATE CASCADE,
  CONSTRAINT `FK_estudiantes_asignatura_secciones` FOREIGN KEY (`Seccion`) REFERENCES `secciones` (`Codigo_Seccion`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;

-- Volcando datos para la tabla reu_db.estudiantes_asignatura: ~0 rows (aproximadamente)
REPLACE INTO `estudiantes_asignatura` (`ID`, `Estudiante_Cedula`, `Estudiante_Nombre`, `Asignatura`, `Seccion`, `Estado`, `Periodo_Academico`, `Nota`, `Nota_Definitiva`) VALUES
	(00001, '00000000', 'Daniel Betancort', 'ING-001', 30231, 'cargando notas', '2026-1', 14, 14);
...
REPLACE INTO `estudiante_periodo_academico` (`ID`, `Cedula_Estudiante`, `Estado`, `Periodo_Academico`, `Carrera`, `Pago`, `Monto_Pago`, `Moneda`, `Modalidad_Pago`, `Entidad_Bancaria`, `Numero_Transferencia`, `Fecha_Pago`, `Fecha_Registro`) VALUES
	(00003, '11111111', 'activo', '2026-1', 'P-INF-2025', 'pendiente', 200.00, 'USD', 'Pago Movil', 'Banco Mercantil', 156987200, '2025-04-18', '2025-04-18 04:00:00');
...
REPLACE INTO `solicitudes_tutor_externo` (`ID`, `Cedula_Tutor`, `Nombre_Tutor`, `Cedula_Solicitante`, `Nombre_Estudiante`, `Estado`, `Fecha_Solicitud`) VALUES
...
REPLACE INTO `solicitudes_tutor_interno` (`ID`, `Cedula_Docente`, `Nombre_Docente`, `Cedula_Solicitante`, `Nombre_Estudiante`, `Estado`, `Fecha_Solicitud`) VALUES
	(00003, '12000111', 'Daniel Bentancourt', '00000000', 'Daniel Betancourt', 'solicitud-enviada', '2025-05-14 04:00:00');
...
-- Volcando datos para la tabla reu_db.trabajo_investigacion: ~2 rows (aproximadamente)
REPLACE INTO `trabajo_investigacion` (`ID`, `Nombre_Investigacion`, `Carrera`, `Cedula_Estudiante`, `Nombre_Estudiante`, `Tutor_Cedula`, `Tutor_Nombre`, `Area_Interes`, `Periodo_Academico`, `Estado`) VALUES
	(00006, 'Bases', 'P-INF-2025', '11111111', 'Jonathan Vargas', '12000123', 'gregorio', 'bases', '2029-2', 'aprobado'),
	(00008, 'Redes avanzadas', 'P-INF-2025', '00000000', 'Daniel Bentancourt', '12022022', 'carlos gonzales', 'Redes avanzadas', '2027-1', 'aprobado');
...
-- Volcando datos para la tabla reu_db.usuarios: ~8 rows (aproximadamente)
REPLACE INTO `usuarios` (`ID_Usuario`, `Password`, `Rol`, `Estado`, `Nombres`, `Apellidos`, `Genero`, `Residente`, `Cedula`, `Telefono_1`, `Telefono_2`, `Correo`, `Direccion_Residencial`, `Codigo_Carnet`, `Fecha_Registro`) VALUES
	('CONTROL', 'vkmUw7aR', 'Control_Estudio', 'Habilitado', 'Nombrecontrol', 'Apellidocontrol', 'Masculino', 'Venezolano', '01203285', '04140023121', NULL, 'controlestudio@email.com', 'Caracas', NULL, '2025-04-11 22:49:57'),
	...
	('ESTUDIANTTE', '4BaEEIc3', 'Estudiante', 'Habilitado', 'Nombreest', 'Apellidoest', 'Femenino', 'Extranjero', '00123741', '0412000123', NULL, 'est@email.com', 'Caracas', 'EST-181', '2025-04-11 22:46:19'),
	...
	('PROFESOR', '1DrVk661', 'Docente', 'Habilitado', 'Nombreprofe', 'Apellidoprofe', 'Masculino', 'Venezolano', '00221221', '0414025369', NULL, 'prof@email.com', 'Caracas', 'PROF-548', '2025-04-11 22:41:47');
...
CREATE TRIGGER `codigo_carnet` BEFORE INSERT ON `usuarios` FOR EACH ROW BEGIN
  ...
  -- Código modificado para generar códigos de carnet según nuevo formato
  IF NEW.Rol = 'Estudiante' THEN
    -- Generar número de 3 dígitos aleatorio
    SET numero_aleatorio = FLOOR(100 + RAND() * 900);
  ...
  ELSEIF NEW.Rol = 'Docente' THEN
    -- Generar número de 3 dígitos aleatorio
    SET numero_aleatorio = FLOOR(100 + RAND() * 900);
    SET nuevo_codigo = CONCAT('PROF-', numero_aleatorio);
